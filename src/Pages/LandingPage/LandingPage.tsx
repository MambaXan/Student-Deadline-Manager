      ...
      <section className="landing-hero">
        <div className="landing-container">
          <div className="landing-hero__content">
            ...
            <p className="landing-hero__subtitle">
              The simplest way to manage university coursework. No accounts, 
              no passwords, no data collection. Just your deadlines and you.
            </p>
            <div className="landing-hero__actions">
              <button
                onClick={() => onNavigate("signup")}
        ...
        <div className="landing-container">
          ...
          <div className="landing-features-grid">
            <div className="landing-feature-card">
              ...
              <p className="landing-feature-description">
                Start adding tasks in seconds. Your data is stored right in your browser, 
            ...
            <div className="landing-feature-card">
              ...
              <p className="landing-feature-description">
                We don't want your email or your data. Everything stays on your device, 
                keeping your academic life private.
              </p>
            </div>
            ...
            <div className="landing-feature-card">
              ...
              <p className="landing-feature-description">
                Organize assignments by course with ease. Visual priority levels help 
                you focus on what's due first.
              </p>
            </div>
          </div>
        </div>
